"""
Django settings for ureyud_196 project.
...
WSGI_APPLICATION = 'ureyud_196.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ureyud_196 API",
    "DESCRIPTION": "API documentation for ureyud_196 App",
    "VERSION": "v1",
}
